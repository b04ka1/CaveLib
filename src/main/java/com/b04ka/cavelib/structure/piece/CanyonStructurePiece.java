...
public class CanyonStructurePiece extends AbstractCaveGenerationStructurePiece {
    ...
    public CanyonStructurePiece(BlockPos chunkCorner, BlockPos holeCenter, int bowlHeight, int bowlRadius, Block surroundCornerOfLiquid) {
        super(CLStructurePieceRegistry.CANYON.get(), chunkCorner, holeCenter, bowlHeight, bowlRadius, null, surroundCornerOfLiquid, null, null);
    }

    public CanyonStructurePiece(BlockPos chunkCorner, BlockPos holeCenter, int bowlHeight, int bowlRadius, Block surroundCornerOfLiquid, Block floor) {
        super(CLStructurePieceRegistry.CANYON.get(), chunkCorner, holeCenter, bowlHeight, bowlRadius, null, surroundCornerOfLiquid, floor, null);
    }

    public CanyonStructurePiece(BlockPos chunkCorner, BlockPos holeCenter, int bowlHeight, int bowlRadius, Block surroundCornerOfLiquid, Block floor, Block belowFloor) {
        super(CLStructurePieceRegistry.CANYON.get(), chunkCorner, holeCenter, bowlHeight, bowlRadius, null, surroundCornerOfLiquid, floor, belowFloor);
    }

    public CanyonStructurePiece(CompoundTag tag) {
        super(CLStructurePieceRegistry.CANYON.get(), tag);
    }

    public CanyonStructurePiece(StructurePieceSerializationContext structurePieceSerializationContext, CompoundTag tag) {
        this(tag);
    }
